...
const ShinyButton = ({
  ...
  return (
    ...
    >
      <span
        className={cn(
          "flex gap-1.5 relative h-full w-full text-sm tracking-wide text-[rgb(0,0,0,65%)] dark:font-light dark:text-[rgb(255,255,255,90%)]",
          textClassName
        )}
        style={{
          maskImage:
      ...
      >
        {text}
        {Icon && <Icon size={16} className="mt-[3px]" />}
      </span>
